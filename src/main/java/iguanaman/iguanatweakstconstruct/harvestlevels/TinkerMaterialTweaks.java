...
public final class TinkerMaterialTweaks {
    ...
    private static void modifyTcon() {
        ...
        updateMaterial(
                _0_stone, "Cactus", 110, 500, 3,
                1.0f); // Preferred weapon material, but also a fast stone-mining material.
        updateMaterial(
                _0_stone,
                "Netherrack",
                123,
                456,
                1,
                1.2f); // good handle, stonebound. Also fast speed because it's from the nether
        ...
        if (TinkerTools.thaumcraftAvailable)
            updateMaterial(
                    ...
                    650,
                    3,
                    1.18f); // a bit faster iron, but slightly worse durability. But extra modifier. Awesome.
        ...
        updateMaterial(
                ...
                650,
                2,
                0.8f); // Poor mans Obsidian-Level Head, but good accessory for reinforced
    ...
    private static void modifyMetallurgyBasePrecious() {
        ...
        updateMaterial(
                ...
                600,
                3,
                1.35f); // Iron + Gold, hard handle with fancyness. high handle modifier therefore!
    ...
    private static void modifyMetallurgyFantasy() {
        ...
        updateMaterial(
                ...
                550,
                2,
                0.9f); // Infuscolium (hlvl2) + deep iron, Reinforced 2, Better Copper
        ...
        updateMaterial(
                ...
                880,
                4,
                1.2f); // Mithril + Silver, enhanced mithril at the cost of durability
    ...
    private static void modifyMetallurgyNether() {
        ...
        updateMaterial(
                _4_bronze, "Shadow Steel", 400, 600, 4, 1.3f); // Shadow Iron + Lemurite, Weakness 2 + Reinforced 2
        ...
        updateMaterial(
                ...
                200,
                6,
                0.5f); // Wither 1, Combat material. Requires manyullyn to mine, but can't mine it
    }
    ...
    private static void updateMaterial(
            int harvestLevel, String matName, int newDurability, int newSpeed, int newAttack, float newHandleModifier) {
